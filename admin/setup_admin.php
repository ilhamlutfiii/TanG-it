          ...
          <!-- catatan admin -->
             <div class="row">
              ...
              <div class="col-md-12">
                ...
                <a href="nambah1.php?id=<?= $row["id"]; ?>"><button type="submit" class="btn btn-primary btn-sm" name="nambah" ><i class="fa fa-user-plus" style="padding-right: 5px;"></i>Tambah</button></a>
                  </div>
                </div>                
              </div>
            </div>
