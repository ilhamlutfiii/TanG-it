...
$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%sayur%'");
$hasil=mysqli_num_rows($query);

$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%buah%'");
$hasil1=mysqli_num_rows($query);

$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%rempah%'");
