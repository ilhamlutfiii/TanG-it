...
<div class="container">
      <?php                  
              $query = mysqli_query($conn, "SELECT * FROM tb_trans WHERE id='$_GET[kd]'");
            ...
            <!--<div class="span4">-->
                <!--<div class="icons-box">-->
                    ...
                    <table>
                    <tr>
                        <td rowspan="7"><img src="img/user.png"  width="200px;" style="margin-right: 20px;"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                        <td></td>
                        <td size="200"><h3>Dari - Tujuan</h3></td>
                        <td><h3>:</h3></td>
            <td><div><h3><?php echo $data['dt']; ?></h3></div></td>
                        </tr>
                        <tr>
                        <td></td>
                        <td><h3>Biaya Ongkir</h3></td>
                        <td><h3>:</h3></td>
                        <td><div><h3><?php echo $data['ongkir']; ?></h3></div></td>
                        </tr>                         
                        <tr>
                        <td></td>
                        <td><h3>No.Hp</h3></td>
                        <td><h3>:</h3></td>
                        <td><div><h3><a href="https://wa.me/<?php echo $data['tlp']; ?>"><i class="fa fa-phone"></i>&nbsp;+<?php echo $data['tlp']; ?></a></h3></div></td>
                        </tr> 
                        <tr>
                        <td></td>
                        <td></td>
                        <td><h3></h3></td>
                        <td><h3></h3></td>
                        <td><div><h3>Silahkan klik nomer hp diatas untuk menghubungi pihak transporter</h3></div></td>
                        </tr>      
