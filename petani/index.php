...
if (isset($_POST["login"]) ) {
  ...
  $result = mysqli_query($conn,"SELECT * FROM tb_petani WHERE username = '$username'");
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form action="" method="post">
              ...
              <div class="form-group">
              <a href="..\login_form.php"> <button type="button" class="btn btn-primary btn-lg btn-block">Kembali</button></a>
              </div>
              <div class="form-group">
          ...
          <!-- label login form -->
          <div class="label">Login Petani</div> 
          <div class="label2">Login Petani</div>
        </div>
      </div>
    </div>
  </div>
