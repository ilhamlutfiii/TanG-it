...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE petani LIKE '%$_SESSION[username]%' AND nama LIKE '%buah%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE petani LIKE '%$_SESSION[username]%' AND nama LIKE '%buah%' LIMIT $awalData, $jumlahDataPerHalaman");
