...
$mhs1 = query("SELECT * FROM tb_hasil WHERE id = $id")[0];
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                        	<input type="hidden" name="id" value="<?= $mhs1["id"]; ?>">
							
                          	<label>Keterangan:</label>
							<input class="form-control" name="keterangan" type="text" value="<?= $mhs1["keterangan"] ?>">
                          <br>
                          <div class="btn-group">
