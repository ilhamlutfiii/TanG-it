...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE petani LIKE '%$_SESSION[username]%' AND nama LIKE '%sayur%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE petani LIKE '%$_SESSION[username]%' AND nama LIKE '%sayur%' LIMIT $awalData, $jumlahDataPerHalaman");
