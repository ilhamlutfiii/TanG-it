	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- page table -->
				<form method="post">
					<center><h2 style="color: green;">Tambah Transporter</h2></center><br>
                  <fieldset>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">					  
                          ...
                          <input class="form-control" name="dt" type="text" value="">
                          <br>
                           <label>No. Hp:</label>
                          <input class="form-control" name="tlp" type="text" value="">
                          <br>
                           <label>Ongkir:</label>
                          <input class="form-control" name="ongkir" type="text" value="">
                          <br>
                          <div class="btn-group">
