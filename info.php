...
$tbl_barang = query("SELECT * FROM tbl_barang ORDER BY id DESC LIMIT 9");

// jika tombol cari ditekan
if (isset($_POST["cari"])) {
	$tbl_barang = cari($_POST["keyword"]);
}
if (!isset($_SESSION)) {
        session_start();
    }
  ...
  <body>
    ...
    <section class="home" id="home">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-center">Info Harga</h2>
            <hr>
          </div>
        </div>
        <br>

        <form method="post" action="" class="form-inline" style="position: absolute;left: 48%;top: 97%;margin-left: -200px;">
